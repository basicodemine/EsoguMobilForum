...
public class bbtk_forum extends Activity {
    //its menu over here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bbtk_forum);
        ...
        go_Forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(bbtk_forum.this,kulup_etkinlik_goster.class);
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString("kulupsection", "bbtk");
                editor.commit();
                startActivity(i);
            }
        });
        ...
        takipet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPrefs.contains("bbtk")){
                    ...
                    Toast.makeText(bbtk_forum.this, "Zaten Kayıtlısın!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute(){
            ...
            pDialog = new ProgressDialog(bbtk_forum.this);
