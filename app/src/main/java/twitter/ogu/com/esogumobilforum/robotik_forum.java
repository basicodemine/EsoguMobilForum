...
public class robotik_forum extends Activity {
   //its menu over here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robotik_forum);
        ...
        go_Forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(robotik_forum.this,kulup_etkinlik_goster.class);
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString("kulupsection", "robotik");
                editor.commit();
                startActivity(i);
            }
        });
        ...
        if(sharedPrefs.contains("robotik")){
        ...
        takipet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPrefs.contains("robotik")){
                    ...
                    Toast.makeText(robotik_forum.this, "Zaten Kayıtlısın!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute(){
            ...
            pDialog = new ProgressDialog(robotik_forum.this);
        ...
        protected String doInBackground(String... arg0) {
            try {
                ...
                postDataParams.put("kusec","robotik");
