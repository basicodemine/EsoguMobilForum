...
public class Constants {
    ...
    public static final String BASE_URL = "http://begodev.com/";
    ...
    public static final String REGISTER_OPERATIONT = "registerT";
    public static final String REGISTER_OPERATIONF = "registerF";
